...
/*
			...
			vec3 transformedVertex =  VectorAdd( MultVec3(rotation, VectorSub(g_vertsOrg[row][corner], translation)), translation);
...
/*
			...
			vec3 transformedVertex =  VectorAdd( ScalarMult(transformedFromBone1, w0), ScalarMult(transformedFromBone2, w1));
			g_vertsRes[row][corner] = transformedVertex;
*/
...
void setBoneTransformation(void)
{
