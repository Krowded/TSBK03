...
void main(void)
{
	const float lightConstant = 1; //Added to control strength of light
	const vec3 light = lightConstant*vec3(0.58, 0.58, 0.58); // Given in VIEW coordinates! You usually specify light sources in world coordinates.
